...
class FormattedText {
	...
	// Set the range of letters that must be capitalized
...
class TextRange {
	...
	// Returns the range constraint specified in the constructor
	covers(position) {
...
class BetterFormattedText {
	...
	// ==> Here we extract the shared state and save memory only
	// referencing a different class claaed TextRange
	getRange(start, end) {
