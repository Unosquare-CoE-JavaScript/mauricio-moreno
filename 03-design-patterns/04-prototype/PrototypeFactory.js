...
//Explanation in CopyThroughSerialization.js
//! ====================== Code starts here ========================

// You can see the 03-Factory Section
class EmployeeFactory {
	/* serializer, main and aux will be setted later */
	// Serializer implements Serializer -> will be the function that clones the object
	// main -> Will create a template with the main address ubication
	// aux -> Will create a template with the auxiliar address ubication

	// Will take the prototype which is based, the name and the suite
