...
// This will generate the commands to the bank account and generate
// recipes to do defined actions
class BankAccountCommand {
	constructor(account, action, amount) {
		this.account = account; // typeof BankAccount
		this.action = action; // Methods of Bankaccount
		this.amount = amount;
